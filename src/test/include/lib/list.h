#ifndef __INCLUDE_LIB_LIST_H__
#define __INCLUDE_LIB_LIST_H__
#include <type.h>
...
static inline void list_splice_init(struct list_head *list,struct list_head *haed)
{
    if (!list_empty(list))
    {
...
#define list_for_each_save(pos,n,head) \
	for (pos = (head) -> next,n = pos -> next;pos != (head); \
	pos = n,n = pos -> next)
#define list_for_each_prev_save(pos,n,head) \
