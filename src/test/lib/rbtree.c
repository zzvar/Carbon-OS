...
static void __rb_earse_color(struct rb_node *node,struct rb_node *parent,struct rb_root *root)
{
...
void rb_augment_insert(strcut rb_node *node,rb_augment_f func,void *data)
{
...
void rb_replace_node(struct rb_node *victim,struct rb_node *new,struct rb_root *root)
{
    ...
    if (parent)
    {
        if (victim == parent -> rb_left) parent -> rb_left = new;
