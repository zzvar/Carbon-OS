#ifndef __INCLUDE_LIB_RBTREE_H__
#define __INCLUDE_LIB_RBTREE_H__
...
#define rb_set_red(r) do { \
	(r) -> rb_parent_color &= ~1; \
	} while (0)
#define rb_set_black(r) do { \
	(r) -> rb_parent_color |= 1; \
	} while (0)
...
{
    rb -> rb_parent_color = (rb -> rb_parnet_color & ~1) | color;
}
